				...
				<h4>Semester</h4>
					...
					<p class="cd-select icon">
						<select class="b-category" name="b_category">
							...
							<option>2nd Semster</option>
							<option>3rd Semster</option>
							<option>4th Semster</option>
							<option>5th Semster</option>
							<option>6th Semster</option>
							<option>7th Semster</option>
							<option>7th Semster</option>
							<option>8th Semster</option>
